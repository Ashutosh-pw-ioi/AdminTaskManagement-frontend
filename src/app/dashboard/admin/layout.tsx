...
const AdminLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: "Default Tasks",
      icon: SquareCheckBig,
      href: "/dashboard/admin/defaulttasks",
    },
    {
      id: "dailytasks",
      label: "Daily Tasks",
  ...
  const getActiveSection = () => {
    ...
    if (pathname.includes("/defaulttasks")) return "defaulttasks";
    if (pathname.includes("/dailytasks")) return "dailytasks";
    if (pathname.includes("/newtasks")) return "newtasks";
